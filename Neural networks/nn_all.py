...
from keras.layers import Dense, Activation, LSTM, Concatenate
import csv
import numpy as np
...
def train_nn(x_train,y_train,x_test,y_test,nn_type):
    ...
    if nn_type == "LSTM":
    ...
    elif nn_type == "Vary Outputs":
        input_lay = Input(shape=(features,))
        h1 = Dense(100)(input_lay)
        ...
        output_lay = Concatenate([steering, accelerator, breaking])
...
#train_nn(x_train,y_train,x_test,y_test,nn_type = "Vary Outputs")
