...
class MyDriver(Driver):
	def __init__(self):
		self.model = load_keras_model('Joris2laagsTanh.h5')
		self.steermodel = load_keras_model('LSTM_FINAL2.h5')
		self.time_offset = 0
		self.time = 0
	...
	def drive(self, carstate: State) -> Command:
		...
		for i in track_edges:
			data.append(i)
		out, _ = predict_output(self.model, data,"MLP")
		_, command.steering = predict_output(self.steermodel, data,"LSTM")
